...
Python and Git comes together with Ubuntu 18.04.  TO verify, I run the following command <!--StartFragment-->
...
The set-up will occupy a place in your PC hard-drive as folder. This is to be expected. Fresh from the set-up in Ubuntu, type
